...
export const Modifica = () => {
    ...
    const sendData = async () => {
      ...
      try {
        ...
        alert("Il tuo annuncio è stato modificato");
        const data = await response.json();
  

        await axios.delete(`${serverURL}/api/v1/annuncio/`, {
            data: {
              annunci: window.localStorage.getItem("modificaID")
            }
          });
    ...
    return (
        <div className="mod-annuncio">
            ...
            <form>
                ...
                <button type="button" onClick={sendData}>modifica annuncio</button>
            </form>
        </div>)
};
